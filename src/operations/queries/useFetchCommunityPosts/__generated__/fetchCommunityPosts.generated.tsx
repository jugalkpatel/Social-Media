 ...
 * });
 */
export function useFetchCommunityPostsQuery(
  ...
  return Apollo.useQuery<
    FetchCommunityPostsQuery,
    FetchCommunityPostsQueryVariables
  >(FetchCommunityPostsDocument, options);
}
export function useFetchCommunityPostsLazyQuery(
...
export type FetchCommunityPostsQueryHookResult = ReturnType<
  typeof useFetchCommunityPostsQuery
>;
export type FetchCommunityPostsLazyQueryHookResult = ReturnType<
  typeof useFetchCommunityPostsLazyQuery
>;
export type FetchCommunityPostsQueryResult = Apollo.QueryResult<
  FetchCommunityPostsQuery,
  FetchCommunityPostsQueryVariables
>;
