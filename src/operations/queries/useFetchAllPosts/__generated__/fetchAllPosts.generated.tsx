 ...
 * });
 */
export function useFetchAllPostsQuery(
  ...
  return Apollo.useQuery<FetchAllPostsQuery, FetchAllPostsQueryVariables>(
    FetchAllPostsDocument,
    options,
  );
}
export function useFetchAllPostsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FetchAllPostsQuery, FetchAllPostsQueryVariables>(
    FetchAllPostsDocument,
    options,
  );
}
export type FetchAllPostsQueryHookResult = ReturnType<
  typeof useFetchAllPostsQuery
>;
export type FetchAllPostsLazyQueryHookResult = ReturnType<
  typeof useFetchAllPostsLazyQuery
>;
export type FetchAllPostsQueryResult = Apollo.QueryResult<
  FetchAllPostsQuery,
  FetchAllPostsQueryVariables
>;
