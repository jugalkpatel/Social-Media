...
export type AuthenticateMutation = { __typename?: 'Mutation', authenticate: { __typename?: 'CommonError', message: string } | { __typename?: 'User', id: string, name: string, picture: string } };
