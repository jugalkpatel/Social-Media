...
export type LeaveCommunityMutation = { __typename?: 'Mutation', leaveCommunity: { __typename?: 'CommonError', message: string } | { __typename?: 'Community', id: string, members: Array<{ __typename?: 'User', id: string } | null> } };
